...
namespace SSD_Components
{
	...
	private:
		...
		std::list<NVM_Transaction_Flash*>::iterator*** head_high_read;//Due to programming limitations, for read queues, MQSim keeps Head_high instead of Tail_low which is described in Alg 1 of the FLIN paper
		std::list<NVM_Transaction_Flash*>::iterator*** head_high_write;//Due to programming limitations, for write queues, MQSim keeps Head_high instead of Tail_low which is described in Alg 1 of the FLIN paper
