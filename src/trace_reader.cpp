...
TraceReader::TraceReader() : opts_(Options{}) {}

TraceReader::TraceReader(Options opts) : opts_(opts) {}

std::vector<Request> TraceReader::load_csv(const std::string& path) const {
